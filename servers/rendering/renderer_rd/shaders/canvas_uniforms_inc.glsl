...
#define INSTANCE_FLAGS_SKIP_SCREEN_TRANSFORM_SNAP (1u << 29)
#define INSTANCE_FLAGS_SCREEN_TRANSFORM_SNAP_X (1u << 30)
#define INSTANCE_FLAGS_SCREEN_TRANSFORM_SNAP_Y (1u << 31)
