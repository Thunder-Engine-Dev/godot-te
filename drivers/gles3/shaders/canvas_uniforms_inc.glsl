...
#define INSTANCE_FLAGS_SKIP_SCREEN_TRANSFORM_SNAP uint(1u << 29u)
#define INSTANCE_FLAGS_SCREEN_TRANSFORM_SNAP_X uint(1u << 30u)
#define INSTANCE_FLAGS_SCREEN_TRANSFORM_SNAP_Y uint(1u << 31u)
